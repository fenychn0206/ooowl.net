...
> [!CAUTION]
>
> 除特别注明外，本博客文章均采用 [(Creative Commons BY-SA 4.0) 知识共享署名 - 相同方式共享 4.0 国际许可协议](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh-hans)，使用过程中您可以自由地共享、演绎，但是必须署名、以相同方式共享、分享时没有附加限制。
>
> 请务必遵守 CC 协议，在使用本仓库内容是务必替换我的信息为你的站点信息，不要将我的内容未经允许以你的名义发布！！！
